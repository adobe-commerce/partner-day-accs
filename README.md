...
```
Email: pd-ny+<SEAT_NUMBER>@adobecreate.com
...
8. From the list of projects, select the project assigned to you. You can search for your project by typing `PD NY <SEAT_NUMBER>`.
